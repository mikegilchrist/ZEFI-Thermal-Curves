...
song_motif_data <- left_join(song_data, chamber_info, by = c("male", "date"))

## Add motif stats to song_data, and arrange columns
song_motif_stats_xy <- full_join(motif_data_full, song_summary, by = c("male", "date")) |>
    relocate(
...
if(FALSE) {
    ...
    right_join_song_motif_stats_xy <- right_join(motif_data_full, song_summary, by = c("male", "date")) |>
        relocate(motif_count.y, .after="motif_count.x") %>%
        relocate(date, .before="motif_count.x") %>%
