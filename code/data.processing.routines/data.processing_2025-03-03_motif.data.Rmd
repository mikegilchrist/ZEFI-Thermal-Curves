...
motif_data_renamed <- data_new  |>
  ...
  mutate(date = lubridate::mdy(date),
    ...
    dplyr::select(!end_song)  ## now redundant with info in length_song

motif_data_detailed <- motif_data_renamed %>% filter(!(is.na(file) & is.na(start_song)))
motif_data_misc <- motif_data_renamed %>% filter((is.na(file) & is.na(start_song)))
