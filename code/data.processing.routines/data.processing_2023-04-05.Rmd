...
motif_data_raw[[1]] <- read.csv(file.path(git_root, "data", "chamber-temp-and-humidity", "HSPi-Round-1-Heat-Trials.csv")) %>% mutate(round = 1) %>%
...
motif_data_raw[[2]] <- read.csv(file.path(git_root, "data", "chamber-temp-and-humidity", "HSPi-Repeatability-Song-Count.csv")) %>%
    mutate(round = 2) %>%
    ungroup()

motif_data_raw[[3]] <-read.csv(file.path(git_root, "data", "chamber-temp-and-humidity", "HSPi-Round-2-Heat-Trials.csv")) %>%
    mutate(round = 3) %>%
